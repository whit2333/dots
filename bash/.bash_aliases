#alias mysql='mysql SANE -u whit -p'



alias root='root -l'
alias vim='vim -X' # does not connect to X server
alias tmux='TERM=xterm-256color tmux '
alias ltmux='TERM=xterm-256color tmux list-sessions'
alias atmux='TERM=xterm-256color tmux attach-session -t'
